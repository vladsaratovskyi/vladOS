...
- `x86_64::instructions::segmentation::CS` for loading the code segment
...
| `use x86_64::instructions::segmentation::{Segment, CS};` | Imports the trait and type required to load the code segment register. |
